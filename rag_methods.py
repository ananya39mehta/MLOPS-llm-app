...
def initialize_vector_db(docs):
    embedding = AzureOpenAIEmbeddings(
        ...
        model="text-embedding-3-large",   # ✅ Azure embedding model
    ...
    # Keep only the last 20 collections
...
def get_conversational_rag_chain(llm):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ...
        You will answer user's queries using the provided context when available. 
        If the context is irrelevant or insufficient, you can also use your own knowledge.\n
        {context}"""),
        MessagesPlaceholder(variable_name="messages"),
        ("user", "{input}"),
    ])
